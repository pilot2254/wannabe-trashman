...
namespace Offsets
{
	constexpr int32 GObjects          = 0x08922950;
	constexpr int32 AppendString      = 0x01368E10;
	constexpr int32 GNames            = 0x088062F8;
	constexpr int32 GWorld            = 0x086C8540;
	constexpr int32 ProcessEvent      = 0x015849D0;
