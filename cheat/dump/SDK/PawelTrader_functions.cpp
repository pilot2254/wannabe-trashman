...
#include "PawelTrader_classes.hpp"
#include "PawelTrader_parameters.hpp"
...
void APawelTrader_C::Kolko_je_spawned_smeti_(int32* Kolko_, int32* Kolko_je_max_)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PawelTrader_C", "Kolko je spawned smeti?");

	Params::PawelTrader_C_Kolko_je_spawned_smeti_ Parms{};
